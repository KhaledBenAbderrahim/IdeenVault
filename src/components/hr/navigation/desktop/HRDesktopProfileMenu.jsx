...
import { hrProfileMenuItems } from '../HRNavigationConfig';

export default function HRDesktopProfileMenu({ user, showMenu, setShowMenu, onLogout }) {
  return (
