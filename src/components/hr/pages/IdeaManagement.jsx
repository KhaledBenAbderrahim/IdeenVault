...
import IdeaFilters from '../../dashboard/ideas/IdeaFilters';
import IdeaHeader from '../../dashboard/ideas/IdeaHeader';
import IdeaPagination from '../../dashboard/ideas/IdeaPagination';
import HRIdeaCard from '../ideas/HRIdeaCard';
import HRIdeaDetails from '../ideas/HRIdeaDetails';
...
export default function IdeaManagement() {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="space-y-4 sm:space-y-6 max-w-7xl mx-auto px-3 sm:px-4 lg:px-8"
    >
      <IdeaHeader
          ...
          {paginatedIdeas.length === 0 && (
            ...
            >
              ...
              <p className="text-gray-500 text-xs sm:text-sm">
                Keine Ideen gefunden. Passen Sie Ihre Filter an.
              </p>
            </motion.div>
          )}
        </div>
